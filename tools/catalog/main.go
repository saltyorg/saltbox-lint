// Command catalog explicitly refreshes the embedded production snapshot.
package main
...
func main() {
	output := flag.String("output", "highlight/catalog/data/catalog.json", "snapshot destination")
	flag.Parse()
